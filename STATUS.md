...
| Deploy | `https://runcard.vercel.app` public since 2026-08-28 (Deployment Protection off). **Live = 2e623ba** (production https://runcard.vercel.app, Vercel deployment runcard-k9md1tc3r, bundle `index-BWTvU3kA.js`, 2026-09-03): the golden-path branch, promoted on the owner's word and frozen for the video.
