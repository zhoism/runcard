...
export const TOOLS: Tool[] = [
  ...
  { name: "get_ensemble", readOnly: true, description: "Run-to-run statistics for every run of the same prepared system as run_id (same ligand, atom types, charges, protein, force fields, solvent, box): n, mean, SD, min, max of ΔG for all runs and for runs ≥ 10 ps, with each run's production length.",
